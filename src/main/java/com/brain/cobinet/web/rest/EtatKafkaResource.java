...
@RestController
@RequestMapping("/api/etat-kafka")
public class EtatKafkaResource {
    private final Logger log = LoggerFactory.getLogger(EtatKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EtatKafkaResource(KafkaProperties kafkaProperties) {
